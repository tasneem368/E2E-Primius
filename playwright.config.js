...
export default defineConfig({
  ...
  /* Reporters: HTML for local, GitHub annotations for CI */
  ...
  use: {
    /* Base URL – drives page.goto('/') style navigation */
    baseURL: process.env.BASE_URL || 'https://primius.ai',
    ...
    /* Default navigation timeout (30s) */
